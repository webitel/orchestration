...
case "$1" in
    ...
    "backup")
        ...
        tar -cvzf ${WEBITEL_DIR}/backup/backup_$TIMESTAMP.tar.gz "${WEBITEL_DIR}/ssl" "${WEBITEL_DIR}/db" "${WEBITEL_DIR}/elasticsearch" "${WEBITEL_DIR}/mongodb_backup/dump"
        rm -rf ${WEBITEL_DIR}/mongodb_backup/dump
